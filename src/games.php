...
$api_args = array("platform"=>"playstation3","relationship" => "wishlist");

try{
	$oauth->fetch("http://api.pwned.com/me/games", null, OAUTH_HTTP_METHOD_POST, array("User-Agent" => "pecl/oauth")); //this will update the users games
